...
<template>
    ...
    <div class="">
        ...
        <div class="border-purple-700 rounded-lg items-center mt-10">
        <SessionMessage :status="status" />

            <Title dir="rtl">القصص الخاصة ب:{{ user.name }}</Title>

            <table class="mx-auto divide-y divide-purple-300 rounded-md border-4 border-purple-700" dir="rtl">
